...
***Advertencia***: actualmente solo está disponible el modelo **XLarge-NoShared**. En el futuro publicaremos el resto de modelos, aunque valores de las tablas están sujetos a cambios. Todos los modelos han sido pre-entrenados con **140** millones de pares de tweets (**70m** positivos y **70m** negativos) durante 3 épocas.


|         | Link |  L |  A | E   | H   | Cross | KNN | M   | Dk  | MH | Params |
|---------|-----:|---:|---:|-----|-----|-------|-----|-----|-----|---|--------|
| Base    |    ? |  6 |  6 | 128 | 768 | Yes   | 32  | 256 | 512 | 4 | 89m    |
| Large   |    ? | 10 | 10 | 128 | 768 | Yes   | 32  | 256 | 512 | 4 | 89m    |
| XLarge  |    ? | 12 | 12 | 128 | 768 | Yes   | 32  | 256 | 512 | 4 | 89m    |
| XLarge-NoShared  |    ? | 12 | 12 | 128 | 768 | No   | 32  | 256 | 512 | 4 | 160m    |
...
# TODO
***
1. NO USAR UNA HIDDEN LAYER PARA ROP!!!
3. Dejar congelar los pesos de las capas durante finetuning.
2. Class_weights modo para calcular automáticamente el pesado de las clases en finetuning.
1. Hacer el distribuidor de carga genérico.
3. Mejorar la interfaz de las salidas de finetuning con tablas.
3. Ejemplos en el README de la utilización sin ficheros de configuración. 
4. Dominios de los parámetros en el README.
5. PEP8.
6. Entrenar los modelos finales.
