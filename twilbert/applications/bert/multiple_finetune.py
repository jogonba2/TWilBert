...
if __name__ == "__main__":
    ...
    ids_ts, x1_ts, x2_ts, y_ts = ut.load_multiple_dataset(test_file,
                                                          id_header,
                                                          text_header,
                                                          aux_header,
                                                          class_header,
    ...
    gen_ts = MultipleFinetuningGenerator(tokenizer, n_classes, bucket_min_a,
                                         bucket_min_b, bucket_max_a,
                                         bucket_max_b, bucket_steps,
                                         preprocessing)
    ...
    ts_gen = gen_ts.generator(ids_ts, x1_ts, x2_ts, y_ts)
